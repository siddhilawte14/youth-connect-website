...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const loginAsStudent = async (credentials: { emailOrPrn: string; name?: string; college?: string }): Promise<{ success: boolean; error?: string }> => {
    ...
    const studentProfile: UserProfile = {
      ...
      email: credentials.emailOrPrn.includes('@') ? credentials.emailOrPrn : `${prn.toLowerCase()}@kkwieer.edu.in`,
      role: 'student',
      college: credentials.college || 'K. K. Wagh Institute of Engineering (KKWIEER)',
